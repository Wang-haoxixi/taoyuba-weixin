	...
	data () {
		return {
			menu: [
				...
				{ path: '/pages/home/resume/list/index', color: '#bfc78c', icon: `${this.$IMAGE_URL}/home-jianli.png`, label: '求职' },
			...
			findMenu: [
				...
				{ path: '/pages/release/register/index', color: '#e3797d', icon: `${this.$IMAGE_URL}/home-peixunban.png`, label: '船员登记' },
				{ path: '/pages/home/info/index', color: '#bfc78c', icon: `${this.$IMAGE_URL}/home-peixunjigou.png`, label: '培训服务' },
				{ label: '渔业咨询', color: '#8dc7af', icon: `${this.$IMAGE_URL}/home-peixunban.png`, path: '/pages/home/news/list/index?type=1' },
				...
				{ label: '企业招聘', color: '#bfc78c', icon: `${this.$IMAGE_URL}/home-jianli.png`, path: '/pages/home/recruit/list/index?type=6' },
