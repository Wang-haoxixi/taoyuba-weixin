	...
	<view class="major-container">
		...
		<view class="content-wrapper" v-else>
			<view v-show="tabsShow">
				<u-tabs-swiper active-color="#ff9999" :bar-style="{background: '#ff9999'}" ref="uTabs" :list="list" :is-scroll="true" @change="tabsChange" :current="current"></u-tabs-swiper>
			</view>
			<swiper :current="swiperCurrent" @transition="transition" @animationfinish="animationfinish" style="height: 100vh">
				...
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100vh;width: 100%;">
						<view class="item">
							<page-machine @validate="onValidate" ref="pageMachine" @hide="hideTabs" @show="showTabs"></page-machine>
						</view>
					</scroll-view>
				</swiper-item>
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100vh;width: 100%;">
						<view class="item">
							<page-saving @validate="onValidate" ref="pageSaving" @hide="hideTabs" @show="showTabs"></page-saving>
						</view>
					</scroll-view>
				</swiper-item>
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100vh;width: 100%;">
						<view class="item">
							<page-signal @validate="onValidate" ref="pageSignal" @hide="hideTabs" @show="showTabs"></page-signal>
						</view>
					</scroll-view>
				</swiper-item>
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100vh;width: 100%;">
						<view class="item">
							<page-alarm @validate="onValidate" ref="pageAlarm" @hide="hideTabs" @show="showTabs"></page-alarm>
						</view>
					</scroll-view>
				</swiper-item>
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100vh;width: 100%;">
						<view class="item">
							<page-fire-control @validate="onValidate" ref="pageFireControl" @hide="hideTabs" @show="showTabs"></page-fire-control>
						</view>
					</scroll-view>
				</swiper-item>
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100vh;width: 100%;">
						<view class="item">
							<page-other @validate="onValidate" ref="pageOther" @hide="hideTabs" @show="showTabs"></page-other>
						</view>
					</scroll-view>
				</swiper-item>
			</swiper>
