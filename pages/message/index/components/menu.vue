	...
	<view class="">
		<scroll-view :scroll-x="true">
			<view class="menu-wrapper">
				<view class="item" v-for="(item, index) in menu" :key="index" @tap="onTo(item)" :class="(index + 1) === type ? 'active' : ''">
...
<script>
	export default {
		data () {
			return {
				menu: [
					{ type: 1, label: '系统', color: '#e9b174', icon: `${this.$IMAGE_URL}/home-kaoshi.png`, path: '/pages/message/list/index?type=1' },
					// { type: 2, label: '审核', color: '#e3797d', icon: `${this.$IMAGE_URL}/home-zhaopin.png`, path: '/pages/message/list/index?type=2' },
					{ type: 2, label: '合同', color: '#77b4e3', icon: `${this.$IMAGE_URL}/home-hetong.png`, path: '/pages/message/list/index?type=3' },
					...
					{ type: 9, label: '其他', color: '#e9b174', icon: `${this.$IMAGE_URL}/home-peixunjigou.png`, path: '/pages/message/list/index?type=6' }
				],
				type: 1
			}
		},
